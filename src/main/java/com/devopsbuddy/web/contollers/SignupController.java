...
public class SignupController {
    ...
    public String signUpPost(@RequestParam(name = "planId", required = true) int planId,
        ...
        if (planId != PlansEnum.BASIC.getId() && planId != PlansEnum.PRO.getId()) {
            ...
            model.addAttribute(ERROR_MESSAGE_KEY, "Plan id doesnt exist");
            return SUBSCRIPTION_VIEW_NAME;
        }
        ...
        if (model.containsKey(DUPLICATED_USERNAME_KEY)) {
            LOG.warn("The username already exists. Displaying error to user.");
            model.addAttribute(SIGNED_UP_MESSAGE_KEY, "false");
        ...
        if (model.containsKey(DUPLICATED_EMAIL_KEY)) {
            LOG.warn("The email already exists. Displaying error to user.");
            model.addAttribute(SIGNED_UP_MESSAGE_KEY, "false");
        ...
        if (null == selectedPlan) {
            LOG.error("The plan id {} couldn not be found. Throwing exception.", planId);
            model.addAttribute(SIGNED_UP_MESSAGE_KEY, "false");
